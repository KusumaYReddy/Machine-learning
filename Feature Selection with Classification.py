...
def writetestpred(testpred, indi, X_train15, X_val15, X_test15, acr):
    ...
    if os.path.exists('ky225_Testclass_Prediction.txt'):
        os.remove('ky225_Testclass_Prediction.txt');
    elif os.path.exists('ky225_Features_Files.txt'):
        os.remove('ky225_Features_Files.txt');

    pred = open('ky225_Testclass_Prediction.txt', 'w+');
    ...
    fea = open('ky225_Features_Files.txt', 'w+');
    fea.write('kusuma yalaka \nNetID: ky225\nStudentID: 31488298')
...
if __name__ == '__main__':
    ...
    #testfile = sys.argv[3];
    testfile= "C:/Users/Kusuma/Desktop/testdata"
    trainfile= "C:/Users/Kusuma/Desktop/traindata"
    tlabelfile="C:/Users/Kusuma/Desktop/traininglabels.txt"
