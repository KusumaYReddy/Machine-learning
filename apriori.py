...
def generateC1(dataSet):
    ...
    for i in productDict:
        ...
        returneSet.append(productDict[i])
        tempArray = []   
    return returneSet
...
def aprioriOutput(rules, dataSet, minimumConfidence):
    ...
    for rule in rules:
        ...
        if confidence >= minimumConfidence:
            ...
            supportOfXandYAppendString = "Support of itemsets: " + str(round(supportOfXandYinPercentage))
...
fileNameInput = input(
    "Enter the name of the transaction file: ")
minimumSupport = int(input("Enter the minimum support value (0 - 100%): "))
minimumConfidence = int(input("Enter the minimum confidence value (0 - 100%): "))


if fileNameInput == '1':
    fileName = "C:/Users/Kusuma/OneDrive/Attachments/data1.txt"
if fileNameInput == '2':
    fileName = "C:/Users/Kusuma/OneDrive/Attachments/data2.txt"
if fileNameInput == '3':
    fileName = "C:/Users/Kusuma/OneDrive/Attachments/data3.txt"
if fileNameInput == '4':
    fileName = "C:/Users/Kusuma/OneDrive/Attachments/data4.txt"
if fileNameInput == '5':
    fileName = "C:/Users/Kusuma/OneDrive/Attachments/data5.txt"
...
AprioriOutput = aprioriOutput(associationRules, dataSet, minimumConfidence)
